#ifndef GZ_MODEL_IMPORTER_FILE_SELECTOR_HH_
#define GZ_MODEL_IMPORTER_FILE_SELECTOR_HH_
...
class FileSelector : public QObject
{
  ...
  signals: void fileReady(const QString &path, gz_model_importer::FileFormat format);
