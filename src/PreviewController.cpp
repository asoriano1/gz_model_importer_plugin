                                      ...
                                      const EntitySpawnPose &_pose)
{
  ...
  gzmsg << "[gz_model_importer] Spawning preview '"
...
void PreviewController::onSpawnComplete(const QString &_name)
{
  ...
  gzmsg << "[gz_model_importer] Preview entity spawned: "
        << _name.toStdString() << "\n";
...
{
  gzwarn << "[gz_model_importer] Preview spawn failed: "
         << _error.toStdString() << "\n";
  clearPreviewState();
...
{
  gzwarn << "[gz_model_importer] Preview removal failed: "
...
{
  gzwarn << "[gz_model_importer] " << _error.toStdString() << "\n";
...
void PreviewController::subscribeToPoseInfo()
{
  ...
  gzmsg << "[gz_model_importer] Subscribed to " << topic << "\n";
}
